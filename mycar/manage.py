...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    #!# add for ultrasonic on togikaidrive
    if cfg.HAVE_ULTRASONIC :
        # togikaidrive内のconfigをインポート
        import config_tgd
        list = ['ultrasonic/' + name for name in config_tgd.ultrasonics_list]
        inputs += list
        list = ['int']*len(config_tgd.ultrasonics_list) 
        types +=list
